...
namespace dbcppp
{
    namespace DBCX3
    {
        namespace AST
        {
            ...
            using network_element_t = boost::variant<
                G_ValueTable,
                G_Message,
                ...
                G_Attribute,
                variant_attribute_t,
                G_ValueDescriptionSigEnvVar,
                G_SignalGroup,
                G_SignalExtendedValueType,
                G_SignalMultiplexerValue
            >;

            struct G_NetworkContainer
                : boost::spirit::x3::position_tagged
            {
                G_Version version;
                ...
                std::vector<network_element_t> elements;
            };
